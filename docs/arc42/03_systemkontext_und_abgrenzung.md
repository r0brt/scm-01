...
- `PostgreSQL` gehört in der Zielarchitektur zur lokal kontrollierten Systemumgebung. Dorthin fliessen Run-Daten, Analyseergebnisse, Validierungsinformationen und Traceability-Metadaten zur späteren Anzeige und Nachvollziehbarkeit zurück.
