...
5. Der Adapter liefert die sechs Ebenen `symptome`, `ursachen`, `emotionen`, `narrative`, `mythen` und `essenz` im versionierten SCM-Vertrag aus `docs/scm.md`, `prompts/v1/analysis.md` und `schemas/analysis.schema.json`.
...
7. Der Run wird mit Analyse-JSON, Validation-Report, Sprachmetadaten und Traceability-Feldern persistiert.
8. Die API antwortet synchron mit dem gespeicherten Run.
