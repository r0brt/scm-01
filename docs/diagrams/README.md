...
- `docs/diagrams/structurizr/c3-web-ui-components.dsl`: C3-Komponentensicht der Web UI mit App Shell, Composer, Pipeline View, Result View, Stage, Archiv, API Client, Pipeline View Model und Frontend-Typen.
